    ...
    public:
        ...
        public:
            SectionIntegratedExtensionBendingStiffnessMatrix(MAST::FieldFunction<DenseMatrix<Real> > &mat,
                                                             MAST::FieldFunction<Real>& h_y,
                                                             MAST::FieldFunction<Real>& h_z,
                                                             MAST::FieldFunction<Real>& off_y,
                                                             MAST::FieldFunction<Real>& off_z);
        ...
        protected:
            ...
            MAST::FieldFunction<DenseMatrix<Real> > &_material_stiffness;
            MAST::FieldFunction<Real> &_h_y, &_h_z, &_off_y, &_off_z;
        };
