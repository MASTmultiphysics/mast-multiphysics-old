...
FESystem::Structures::PistonTheory2D::PistonTheory2D():
...
void
FESystem::Structures::PistonTheory2D::clear()
{
...
FESystemUInt
FESystem::Structures::PistonTheory2D::getNElemDofs() const
{
...
void
FESystem::Structures::PistonTheory2D::getActiveElementMatrixIndices(std::vector<FESystemUInt>& vec)
{
...
void
FESystem::Structures::PistonTheory2D::getStressTensor(const FESystem::Geometry::Point& pt, const FESystem::Numerics::VectorBase<FESystemDouble>& sol,
...
void
FESystem::Structures::PistonTheory2D::calculateForceVector(const FESystem::Numerics::VectorBase<FESystemDouble>& sol, const FESystem::Numerics::VectorBase<FESystemDouble>& vel, FESystem::Numerics::VectorBase<FESystemDouble>& force)
{
    FESystemAssert0(this->if_initialized, FESystem::Exception::InvalidState);
...
void
FESystem::Structures::PistonTheory2D::calculateTangentMatrix(const FESystem::Numerics::VectorBase<FESystemDouble>& sol, const FESystem::Numerics::VectorBase<FESystemDouble>& vel,
