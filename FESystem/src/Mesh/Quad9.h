...
#ifndef __fesystem_quad9_h__
#define __fesystem_quad9_h__
...
namespace FESystem
{
	namespace Mesh
	{
         ...
         *
         */
		class Quad9: public FESystem::Mesh::QuadElemBase
		{
		public:
            /*!
             ...
             */
            static std::auto_ptr<FESystem::Utility::Table<FESystemUInt> > quad9_node_dim_ID_table;
