...
#ifndef __fesystem_tri7_h__
#define __fesystem_tri7_h__
...
namespace FESystem
{
	...
	{
        /*!
         *   Defines a 7-noded triangular element lying in a plane surface. The node connectivity is defined as shown below. 
         ...
         *
         */
		class Tri7: public FESystem::Mesh::TriElemBase
		{
		public:
            /*!
		...
		protected:
             ...
             */
            static std::auto_ptr<FESystem::Numerics::MatrixBase<FESystemDouble> > tri7_nondegenerate_to_degenerate_element_mapping;
