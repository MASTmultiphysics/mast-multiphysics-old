...
namespace FESystem
{
    ...
    {
        /*!
         *   This specializes the FunctionMappingBase class for polar functions for a specified basis of 
         *   transformation (Jacobian). 
         */
        template <typename ValType>
        class PolarFunctionMapping: public FESystem::Functions::FunctionMappingBase<ValType>
        {
        public:
            /*!
             *   Constructor
             */
            PolarFunctionMapping();
            
            virtual ~PolarFunctionMapping();
...
#endif // __fesystem_polar_function_mapping_h__
