...
void nonlinearSolution(FESystemUInt dim, FESystem::Mesh::ElementType elem_type, FESystemUInt n_elem_nodes, const
                       ...
                       void (*calculateBeamStructuralMatrices)(FESystemBoolean if_nonlinear, FESystem::Mesh::ElementType elem_type, FESystemUInt n_elem_nodes,
    ...
    while (call_back != FESystem::NonlinearSolvers::SOLUTION_CONVERGED)
    {
        switch (call_back)
        {
            ...
            case FESystem::NonlinearSolvers::EVALUATE_RESIDUAL:
            {
                ...
                calculateBeamStructuralMatrices(true, elem_type, n_elem_nodes, dof_map, mesh, sol, internal_force, rhs, stiff_mat, dummy);
